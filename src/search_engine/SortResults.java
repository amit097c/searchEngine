...
public class SortResults {
	...
	// Sorts search output in Descending Rank. ArrayList contains list of files that
	// have the given phrase.
	public static Map<String, Integer> sortByRank(ArrayList<String> as, String phrase) {
		HashMap<String, Integer> wordCount = new HashMap<>();

		for (String fileName : as) {
			String[] words = InvertedIndex.getWordsFromFile(new File("WebPages/" + fileName));
